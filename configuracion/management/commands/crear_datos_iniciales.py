# configuracion/management/commands/crear_datos_iniciales.py
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('[OK] Datos iniciales creados exitosamente!'))
    ...
    def crear_sillas(self):
        ...
        for silla_data in sillas_data:
            ...
            if created:
                creadas += 1
                self.stdout.write(f'  [OK] Creada: {silla}')
            else:
    ...
    def crear_servicios(self):
        ...
        for servicio_data in servicios_data:
            ...
            if created:
                creados += 1
                self.stdout.write(f'  [OK] Creado: {servicio}')
            else:
    ...
    def crear_configuracion(self):
        ...
        for config in configuraciones:
            ...
            if created:
                creadas += 1
                self.stdout.write(f'  [OK] Configurado: {config["nombre"]} ({config["demanda"]})')
            else:
